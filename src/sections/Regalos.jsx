...
const Programa = () => {
  return (
    <section className="flex flex-col h-[100vh] justify-center items-center bg-soft-pink py-4 md:py-11 relative">
       <img src={mono} alt="adorno moño" className="w-full h-[150px] absolute top-2" />
      <div className="flex flex-col items-center pt-6 z-10">
        ...
        <img src={regalo} alt="adorno regalo" className="w-[150px] h-[150px] mb-3" />  
        <p className="font-montserrat text-xl px-2 text-center text-dark-brown md:text-2xl md:w-[500px] md:mt-5 mb-3">
        O puedo sugerirte la siguiente opción
        </p>
        <img src={sobreRegalo} alt="adorno regalo" className="w-[100px] h-[100px] mb-3" /> 
        <p className="font-mea font-bold text-3xl px-2 text-center text-dark-brown md:text-2xl md:w-[500px] md:mt-5">
        Lluvia de Sobres
        </p> 
      </div>
